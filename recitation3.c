...
int main(int argc, char* argv[]){
  ...
  while (k <= INT_MAX) {
    ...
    this loop never ends because the for loop condition is k <= INT_MAX and within the loop k is being doubled.
    it will never reach greater than INT_MAX as the loop will quickly overflow making the condition always true.
